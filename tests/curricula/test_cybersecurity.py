"""
Automated Test Suite for Cybersecurity & Information Assurance Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.cybersecurity import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class CYBERCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Cybersecurity & Information Assurance")
        self.assertEqual(DISCIPLINE_CODE, "CYBER")

"""
Automated Test Suite for Architecture, Urbanism & Spatial Computation Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.architecture_spatial_design import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class ARCHCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Architecture, Urbanism & Spatial Computation")
        self.assertEqual(DISCIPLINE_CODE, "ARCH")

"""
Automated Test Suite for Civil, Structural & Environmental Engineering Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.civil_environmental import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class CECurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Civil, Structural & Environmental Engineering")
        self.assertEqual(DISCIPLINE_CODE, "CE")

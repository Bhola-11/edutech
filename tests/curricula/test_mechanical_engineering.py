"""
Automated Test Suite for Mechanical & Aerospace Engineering Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.mechanical_engineering import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class MECurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Mechanical & Aerospace Engineering")
        self.assertEqual(DISCIPLINE_CODE, "ME")

"""
Automated Test Suite for Electrical & Electronic Engineering Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.electrical_engineering import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class EECurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Electrical & Electronic Engineering")
        self.assertEqual(DISCIPLINE_CODE, "EE")

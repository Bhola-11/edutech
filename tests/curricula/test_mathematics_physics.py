"""
Automated Test Suite for Pure & Applied Mathematics, Physics & Computation Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.mathematics_physics import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class MATHCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Pure & Applied Mathematics, Physics & Computation")
        self.assertEqual(DISCIPLINE_CODE, "MATH")

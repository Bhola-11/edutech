"""
Automated Test Suite for Business Administration, Economics & Finance Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.business_finance import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class BUSCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Business Administration, Economics & Finance")
        self.assertEqual(DISCIPLINE_CODE, "BUS")

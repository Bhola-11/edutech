"""
Automated Test Suite for Data Science & Big Data Analytics Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.data_science import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class DSCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Data Science & Big Data Analytics")
        self.assertEqual(DISCIPLINE_CODE, "DS")

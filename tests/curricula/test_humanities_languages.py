"""
Automated Test Suite for Humanities, Philosophy & World Literature Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.humanities_languages import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class HUMCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Humanities, Philosophy & World Literature")
        self.assertEqual(DISCIPLINE_CODE, "HUM")

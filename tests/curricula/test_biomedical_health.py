"""
Automated Test Suite for Biomedical Engineering & Health Informatics Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.biomedical_health import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class BMECurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Biomedical Engineering & Health Informatics")
        self.assertEqual(DISCIPLINE_CODE, "BME")

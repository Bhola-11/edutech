"""
Automated Test Suite for Computer Science & Software Engineering Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.computer_science import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class CSCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Computer Science & Software Engineering")
        self.assertEqual(DISCIPLINE_CODE, "CS")

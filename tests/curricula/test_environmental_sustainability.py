"""
Automated Test Suite for Earth Systems Science & Sustainable Development Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.environmental_sustainability import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class ENVCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Earth Systems Science & Sustainable Development")
        self.assertEqual(DISCIPLINE_CODE, "ENV")

"""
Automated Test Suite for Artificial Intelligence & Machine Learning Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.artificial_intelligence import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class AICurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Artificial Intelligence & Machine Learning")
        self.assertEqual(DISCIPLINE_CODE, "AI")

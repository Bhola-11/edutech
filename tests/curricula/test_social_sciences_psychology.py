"""
Automated Test Suite for Psychological Sciences & Behavioral Analytics Academic Curriculum
"""

from django.test import SimpleTestCase
from apps.courses.curricula.social_sciences_psychology import CURRICULUM_NAME, DISCIPLINE_CODE, COURSES

class PSYCurriculumValidationTests(SimpleTestCase):
    def test_curriculum_metadata(self):
        self.assertEqual(CURRICULUM_NAME, "Psychological Sciences & Behavioral Analytics")
        self.assertEqual(DISCIPLINE_CODE, "PSY")
